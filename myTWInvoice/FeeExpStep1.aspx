<%@ Page Title="台灣會計 | 費用申請單-匯出資料" Language="C#" MasterPageFile="~/Site_S_UI.master" AutoEventWireup="true" CodeFile="FeeExpStep1.aspx.cs" Inherits="myInvoice_Extend_FeeExpStep1" %>
    ...
    <div class="myContentBody">
        <div class="ui attached segment grey-bg lighten-5">
            ...
            <div id="formData" class="ui small form attached green segment">
                ...
                <div class="three fields">
                    <div class="required field">
                        <label>付款人名稱</label>
                        <asp:TextBox ID="tb_PayWho" runat="server" MaxLength="50" autocomplete="off">寶工實業股份有限公司</asp:TextBox>
                    </div>
                    <div class="required field">
                        <label>付款人帳號</label>
                        <asp:TextBox ID="tb_PayAcc1" runat="server" MaxLength="32" autocomplete="off"></asp:TextBox>
                    </div>
                    <div class="required field">
                        <label>付費帳戶</label>
                        <asp:TextBox ID="tb_PayAcc2" runat="server" MaxLength="32" autocomplete="off"></asp:TextBox>
                    </div>
                </div>
                <div class="ui grid">
            ...
            <div class="ui message">
                ...
                <ul class="list">
                    <li>資料庫：台灣寶工</li>
                    <li>資料來源：ERP費用申請單 & PKEF供應商基本資料。</li>
                </ul>
            </div>
            <!-- 基本資料 End -->
            <!-- 列表 S -->
