...
public partial class myInvoice_Extend_FeeExpStep2 : SecurityIn
{
    ...
    protected void btn_Next_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            _col.Add("PayWho", "付款人名稱");
            _col.Add("PayAcc1", "付款人帳號");
            _col.Add("PayAcc2", "付費帳戶");
            _col.Add("tw_AccName", "收款人名稱");
            _col.Add("tw_Account", "收款人帳號");
            _col.Add("tw_BankID", "銀行代號");
            _col.Add("tw_BankName", "銀行名稱");
            _col.Add("PayPrice", "付款金额");
            _col.Add("PayERPID", "ERP單號");
