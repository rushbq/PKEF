<%@ Page Title="深圳-工具BBC | 匯入Excel" Language="C#" MasterPageFile="~/SiteMaster.master" AutoEventWireup="true" CodeFile="ImportStep2.aspx.cs" Inherits="mySZBBC_ImportStep2" %>
                ...
                <asp:Panel ID="pal_reStock" runat="server" CssClass="section row">
                    <div class="col s12">
                        ...
                        <asp:DropDownList ID="ddl_reStockType" runat="server" CssClass="browser-default">
                            <asp:ListItem Value="">-- 退貨庫別 --</asp:ListItem>
                            <asp:ListItem Value="A05">A05</asp:ListItem>
                            <asp:ListItem Value="B05">B05</asp:ListItem>
                        </asp:DropDownList>
                    </div>
                </asp:Panel>
                <div class="section row">
                    ...
                    <div class="col s12">
                        ...
                        <div>
                            <ul class="collection">
                                ...
                                <li class="collection-item"><i class="material-icons left">info</i>京東POP、天貓商品對應為一對多,請<a href="<%=fn_Params.WebUrl %>mySZBBC/RefCopmg.aspx?Mall=2">前往此頁設定</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
