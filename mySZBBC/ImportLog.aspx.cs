...
public partial class mySZBBC_ImportLog : SecurityIn
{
    ...
    public string Page_SearchUrl
    {
        get
        {
            ...
            return string.IsNullOrWhiteSpace(tempUrl) ? "{0}mySZBBC/ImportList.aspx".FormatThis(fn_Params.WebUrl) : Server.UrlDecode(tempUrl);
        }
        set
        {
    ...
    public string UploadFolder
    {
        get
        {
            return "{0}SZBBC/".FormatThis(System.Web.Configuration.WebConfigurationManager.AppSettings["Ftp_RefUrl"] + System.Web.Configuration.WebConfigurationManager.AppSettings["File_Folder"]);
        }
        set
        {
