...
public partial class mySZBBC_StockImportStep1 : SecurityIn
{
    ...
    protected void lbtn_Next_Click(object sender, EventArgs e)
    {
        ...
        {
            //導至下一步
            Response.Redirect("{0}mySZBBC/StockImportStep2.aspx?dataID={1}".FormatThis(
                fn_Params.WebUrl
                , DataID));
            return;
        }
    ...
    {
        return "{0}SZBBC/ECStock/".FormatThis(System.Web.Configuration.WebConfigurationManager.AppSettings["File_Folder"]);
    }
