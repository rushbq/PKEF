...
public partial class mySZBBC_Import_VC : SecurityIn
{
    ...
    public string Page_SearchUrl
    {
        get
        {
            string tempUrl = "{0}mySZBBC/ImportList.aspx?Mall=3".FormatThis(fn_Params.WebUrl);
    ...
    {
        return "{0}SZBBC/VCGroup/".FormatThis(System.Web.Configuration.WebConfigurationManager.AppSettings["File_Folder"]);
    }
    ...
    {
        return "{0}SZBBC/{1}/".FormatThis(System.Web.Configuration.WebConfigurationManager.AppSettings["File_Folder"], traceId);
    }
