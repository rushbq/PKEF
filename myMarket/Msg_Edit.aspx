<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Msg_Edit.aspx.cs" Inherits="Msg_Edit" %>
...
<body class="MainArea">
    <form id="form1" runat="server">
            ...
            <table class="TableModify table table-bordered">
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="TableModifyTd text-danger B" style="width: 400px">
                    ...
                    <tr>
                        <td class="TableModifyTdHead">回覆信-收件者 <strong><a href="#btn-Desc">(A)</a></strong>
                        </td>
                        <td class="TableModifyTd" colspan="3">
                            <asp:Label ID="lb_AreaName" runat="server" CssClass="label label-default" Visible="false"></asp:Label>
                    ...
                    <tr>
                        <td class="TableModifyTdHead">回覆信-寄件者
                        </td>
                        <td class="TableModifyTd" colspan="3">
                    ...
                    <!-- 轉寄欄位 Start -->
                    <tr class="Must">
                        <td class="TableModifyTdHead" rowspan="3">回覆信轉寄對象 <strong><a href="#btn-Desc">(B)</a></strong><br />
                    ...
                    <!-- 轉寄承辦人員 Start -->
                    <tr class="Must">
                        <td class="TableModifyTdHead" rowspan="2">轉寄承辦人員 <strong><a href="#btn-Desc">(C)</a></strong><br />
        ...
        <div id="btn-Desc" class="SubmitAreaS">
