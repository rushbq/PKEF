<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Msg_Search.aspx.cs" Inherits="Msg_Search" %>
...
<body class="MainArea">
    <form id="form1" runat="server">
        <div class="Navi">
            <a>
                <%=Application["WebName"]%></a>&gt;<a>業務行銷</a>&gt;<span>官網網站訊息</span>
        </div>
        <div class="h2Head">
            <h2>官網網站訊息</h2>
        </div>
            ...
            <div class="SysTab3">
                <ul>
                    <li <%if (Param_Type.Equals("1"))
                          { %>class="TabAc"
                        <%} %>><a href="Msg_Search.aspx?t=1">一般訊息</a></li>
                    <li <%if (Param_Type.Equals("2"))
                          { %>class="TabAc"
                        <%} %>><a href="Msg_Search.aspx?t=2">作廢信件</a></li>
                </ul>
            </div>
                    ...
                    <tr id="trItem" runat="server">
                        ...
                        <td align="center">
                            <asp:PlaceHolder ID="ph_Edit" runat="server">
                                <a class="btn btn-primary btn-sm" href="Msg_Edit.aspx?DataID=<%# Server.UrlEncode(Cryptograph.MD5Encrypt(Eval("InquiryID").ToString(), DesKey))%>">
                                    <span class="glyphicon glyphicon-pencil"></span>&nbsp;訊息回覆
                                </a>
                            </asp:PlaceHolder>
                            <asp:PlaceHolder ID="ph_View" runat="server">
                                <a class="btn btn-default btn-sm" href="Msg_View.aspx?DataID=<%# Server.UrlEncode(Cryptograph.MD5Encrypt(Eval("InquiryID").ToString(), DesKey))%>" style="margin-top:3px;">
