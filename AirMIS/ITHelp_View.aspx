                                    ...
                                    <div class="eight wide field">
                                        ...
                                        <div class="fields">
                                            <div class="ten wide field">
                                                <label>申請類別</label>
                                                <div class="ui basic label">
                                                    <asp:Literal ID="rbl_ApplyType" runat="server"></asp:Literal>
                                                </div>
                                            </div>
                                            <div class="six wide field">
                                                <label>報修方式</label>
                    ...
                    <div class="ui sticky">
                        ...
                        <div class="ui vertical text menu">
                            ...
                            <asp:Panel ID="pl_doJob" runat="server" CssClass="item">
                                <a href="<%:fn_Params.WebUrl %>AirMIS/ITHelp_Edit.aspx?id=<%:Req_DataID %>" class="ui small green button"><i class="fighter jet icon"></i>前往處理</a>
                            </asp:Panel>
                            <div class="item">
