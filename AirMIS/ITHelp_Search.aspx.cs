...
public partial class AirMIS_ITHelp_Search : SecurityIn
{
    //設定FTP連線參數
    ...
    private void LookupDataList(int pageIndex)
    {
        ...
        try
        {
            ...
            //----- 原始資料:取得所有資料 -----
            var query = _data.Get_IThelpList(search, StartRow, RecordsPerPage, true
    ...
    protected void lvDataList_ItemCommand(object sender, ListViewCommandEventArgs e)
    {
        ...
        {
            //----- 方法:刪除資料 -----
            if (false == _data.Delete_ITHelp(Get_DataID))
            {
            ...
            {
                //刪除檔案
                string ftpFolder = "{0}IT_Help/{1}".FormatThis(
    ...
    protected void btn_Excel_Click(object sender, EventArgs e)
    {
        ...
        //----- 原始資料:取得所有資料 -----
        int DataCnt = 0;
        var _rowData = _data.Get_IThelpList(search, -1, -1, false
            , out DataCnt, out ErrMsg);
    ...
    public string thisPage
    {
        get
        {
            return "{0}ITHelp_Search.aspx".FormatThis(FuncPath());
        }
        set
        {
