        ...
        <div class="ui small menu toolbar">
            <div class="item">
                <div class="ui small breadcrumb">
                    ...
                    <h5 class="active section red-text text-darken-2">資訊需求
                    </h5>
                </div>
            </div>
                                ...
                                <div class="fields">
                                    ...
                                    <div class="eight wide field">
                                        ...
                                        <div class="fields">
                                            <div class="ten wide field">
                                                <label>申請類別</label>
                                                <asp:RadioButtonList ID="rbl_ApplyType" runat="server" RepeatDirection="Horizontal">
                                                    <asp:ListItem Value="1" Selected="True">&nbsp;一般需求&nbsp;&nbsp;</asp:ListItem>
                                                    <asp:ListItem Value="2">&nbsp;權限申請&nbsp;&nbsp;</asp:ListItem>
                                                    <asp:ListItem Value="3">&nbsp;專案</asp:ListItem>
                                                </asp:RadioButtonList>
                                            </div>
                                            <div class="six wide field">
                                                <label>報修方式</label>
                                        ...
                                        <div class="two fields">
                                            ...
                                            <div class="field">
                                                ...
                                                <div class="ui teal basic label">
                                                    <asp:Literal ID="lt_ReqClass" runat="server">系統自動歸類</asp:Literal>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="fields">
                                            ...
                                            <div class="ui feed timeline">
                                                <asp:ListView ID="lv_ProcList" runat="server" ItemPlaceholderID="ph_Items" OnItemDataBound="lv_ProcList_ItemDataBound" OnItemCommand="lv_ProcList_ItemCommand">
                                                    ...
                                                    <ItemTemplate>
                                                        <div class="event">
                                                            <div class="label">
                                                                <img src="<%:fn_Params.CDNUrl%>images/common/img-user.jpg" alt="user" />
                                                            </div>
                                                            <div class="content">
        ...
        <asp:PlaceHolder ID="ph_Modals" runat="server">
            ...
            <div id="tipPage" class="ui modal">
                ...
                <div class="content">
                    ...
                    <ul class="ui list">
                        <li><span>新需求</span>：通知執行單位(資訊部)、轉寄人員(若有勾選)</li>
                        ...
                        <li><span>權限申請</span>：通知部門主管，需主管核准。</li>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ScriptContent" runat="Server">
    ...
    <script>
        ...
        $('.ac-Employee').search({
            ...
            , apiSettings: {
                url: '<%=fn_Params.WebUrl%>Ajax_Data/GetData_Users_v1.ashx?q={query}&v=1.0',
    ...
    <script>
        ...
        function getUserList() {
            $.ajax({
                ...
                type: 'POST',
                dataType: "json",
                url: "<%=fn_Params.WebUrl%>Ajax_Data/Json_UserList.aspx",
                data: {
                    block: 'Y'
                },
                error: function () {
