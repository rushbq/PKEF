    ...
    <div class="myContentHeader">
        <div class="ui small menu toolbar">
            ...
            <div class="right menu">
                ...
                <a href="ITHelp_Edit.aspx" class="item"><i class="plus icon"></i><span class="mobile hidden">新增需求</span></a>
                ...
                <a href="<%=fn_Params.WebUrl %>Recording/IT_HelpSummary.aspx" class="item"><i class="chart bar icon"></i><span class="mobile hidden">統計</span></a>
            </div>
        </div>
    </div>
    <!-- 工具列 End -->
            ...
            <asp:ListView ID="lvDataList" runat="server" ItemPlaceholderID="ph_Items" OnItemDataBound="lvDataList_ItemDataBound" OnItemCommand="lvDataList_ItemCommand">
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td class="center aligned collapsing">
                            <a class="ui small grey basic icon button" href="<%=FuncPath() %>ITHelp_View.aspx?id=<%#Eval("DataID") %>" title="看明細">
                                <i class="file alternate icon"></i>
                            </a>
                            <asp:PlaceHolder ID="ph_Edit" runat="server">
                                <a class="ui small teal basic icon button" href="<%=FuncPath() %>ITHelp_Edit.aspx?id=<%#Eval("DataID") %>" title="編輯">
...
<asp:Content ID="Content4" ContentPlaceHolderID="ScriptContent" runat="Server">
    ...
    <script>
        ...
        $('.ac-Dept').search({
            ...
            , apiSettings: {
                url: '<%=fn_Params.WebUrl%>Ajax_Data/GetData_Depts.ashx?q={query}',
    ...
    <script>
        ...
        $('.ac-Employee').search({
            ...
            , apiSettings: {
                url: '<%=fn_Params.WebUrl%>Ajax_Data/GetData_Users_v1.ashx?q={query}',
                onResponse: function (ajaxResp) {
                    //宣告空陣列
                    var response = {
                        results: {}
