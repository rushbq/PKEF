...
public class dbConn
{
    ...
    private static string ConnString(DBS dbs)
    {
        switch ((int)dbs)
        {
            ...
            case 3:
                return System.Web.Configuration.WebConfigurationManager.AppSettings["dbCon_ReportCenter"];
            ...
            case 6:
                return System.Web.Configuration.WebConfigurationManager.AppSettings["dbCon_Science"];

            case 7:
                return System.Web.Configuration.WebConfigurationManager.AppSettings["dbCon_ERPTAX"];
                
            case 8:
                return System.Web.Configuration.WebConfigurationManager.AppSettings["dbCon_DSCSYS"];

            case 9:
                return System.Web.Configuration.WebConfigurationManager.AppSettings["dbCon_PKANA"];
