<%@ Page Title="促銷活動設定" Language="C#" MasterPageFile="~/Site_S_UI.master" AutoEventWireup="true" CodeFile="PromoConfig_Edit.aspx.cs" Inherits="myTWBBC_Mall_PromoConfig_Edit" %>
                ...
                <div class="ui small form attached segment">
                            ...
                            <table class="ui very basic celled table">
                                <tr>
                                    ...
                                    <td class="collapsing grey-text">
                                        (<span class="red-text">商城購買金額</span>達成設定金額時,送指定贈品)
                                    </td>
                                </tr>
                                <tr>
                                    <td class="collapsing">
                    ...
                    <div class="ui grid">
                        ...
                        <div class="twelve wide column right aligned">
                            <button id="doSaveThenStay" type="button" class="ui green small button"><i class="save icon"></i>儲存設定</button>
