<%@ Page Title="台灣電商BBC | 匯入記錄" Language="C#" MasterPageFile="~/Site_S_UI.master" AutoEventWireup="true" CodeFile="ImportList.aspx.cs" Inherits="myTWBBC_Mall_ImportList" %>
        ...
        <div class="ui orange attached segment">
            <div class="ui small form">
                <div class="fields">
                    ...
                    <div class="six wide field">
                        <label>關鍵字查詢</label>
                        <asp:TextBox ID="filter_Keyword" runat="server" autocomplete="off" placeholder="查詢:平台單號, 客戶, 追蹤編號" MaxLength="20"></asp:TextBox>
                    </div>
                </div>
            </div>
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td class="left aligned collapsing">
                            ...
                            <a class="ui small grey basic icon button" href="<%#fn_Params.WebUrl %>myTWBBC_Mall/View.aspx?id=<%#Eval("Data_ID") %>" title="查看記錄">
