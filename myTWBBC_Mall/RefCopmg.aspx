<%@ Page Title="客戶商品自訂對應" Language="C#" MasterPageFile="~/Site_S_UI.master" AutoEventWireup="true" CodeFile="RefCopmg.aspx.cs" Inherits="myTWBBC_Mall_RefCopmg" %>
    ...
    <div class="myContentHeader">
        <div class="ui small menu toolbar">
            ...
            <div class="right menu">
                <%--<a href="<%=fn_Params.WebUrl%>myTWBBC_Mall_Extend/RefCopmg_Import.aspx" class="item" target="_blank"><i class="copy icon"></i><span class="mobile hidden">匯入對應表</span></a>--%>
                ...
                <div class="ui small form">
                    <div class="eight wide column">
                        <div class="fields">
                            ...
                            <div class="three wide required field">
                                <label>客戶品號</label>
                                <asp:TextBox ID="tb_CustModelNo" runat="server" autocomplete="off"></asp:TextBox>
                            </div>
                            <div class="seven wide field">
                                <label>客戶規格</label>
                                <div class="fields">
                                    <div class="eleven wide field">
                                        <asp:TextBox ID="tb_CustSpec" runat="server" autocomplete="off"></asp:TextBox>
                                    </div>
