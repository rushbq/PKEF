...
public partial class Ascx_StepMenu : System.Web.UI.UserControl
{
    protected void Page_Load(object sender, EventArgs e)
    {
        //填入選項
        List<TabMenu> listTab = new List<TabMenu>();
        listTab.Add(new TabMenu(1, "上傳Excel", "注意上傳格式"));
        listTab.Add(new TabMenu(2, "匯入Excel資料", "選擇要匯入的工作表"));
        listTab.Add(new TabMenu(3, "資料整理", "編輯Excel資料"));
        listTab.Add(new TabMenu(4, "確認轉入資料", "檢查待匯入資料"));
        listTab.Add(new TabMenu(5, "完成", "資料進入排程,等待轉入ERP"));
