                    ...
                    <div class="card-content">
                        <div class="row">
                            ...
                            <div class="input-field col s4 right-align">
                                ...
                                <a href="<%=Application["WebUrl"] %>mySHInvoice_E/ImportStep1.aspx" class="btn waves-effect waves-light red" title="開始匯入"><i class="material-icons">add</i></a>
                            ...
                            <tr>
                                ...
                                <td class="center-align">
                                    <asp:PlaceHolder ID="ph_Edit" runat="server">
                                        <a href="<%=Application["WebUrl"] %>mySHInvoice_E/ImportStep2.aspx?dataID=<%#Eval("Data_ID") %>" class="btn waves-effect waves-light green" title="繼續匯入"><i class="material-icons">edit</i></a>
                                    </asp:PlaceHolder>
                                    <a href="<%=Application["WebUrl"] %>mySHInvoice_E/ImportLog.aspx?dataID=<%#Eval("Data_ID") %>" class="btn waves-effect waves-light blue" title="查看LOG"><i class="material-icons">access_time</i></a>
