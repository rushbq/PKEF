...
public partial class mySHInvoiceE_ImportStep1 : SecurityIn
{
    ...
    protected void lbtn_Next_Click(object sender, EventArgs e)
    {
        ...
        {
            //導至下一步
            Response.Redirect("{0}mySHInvoice_E/ImportStep2.aspx?dataID={1}".FormatThis(
                Application["WebUrl"]
                , DataID));
            return;
        }
    ...
    {
        return "{0}SHInvoice/{1}/".FormatThis(System.Web.Configuration.WebConfigurationManager.AppSettings["File_Folder"], traceID);
    }
