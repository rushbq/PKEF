...
public partial class mySHInvoiceE_ImportLog : SecurityIn
{
    ...
    public string Page_SearchUrl
    {
        get
        {
            string tempUrl = CustomExtension.getCookie("EF_SHInvoice");

            return string.IsNullOrWhiteSpace(tempUrl) ? "{0}mySHInvoice_E/ImportList.aspx".FormatThis(fn_Params.WebUrl) : Server.UrlDecode(tempUrl);          
        }
        set
        {
    ...
    public string UploadFolder
    {
        get
        {
            return "{0}SHInvoice/".FormatThis(System.Web.Configuration.WebConfigurationManager.AppSettings["Ftp_RefUrl"] + System.Web.Configuration.WebConfigurationManager.AppSettings["File_Folder"]);
        }
        set
        {
