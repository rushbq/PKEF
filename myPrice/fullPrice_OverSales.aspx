<%@ Page Language="C#" AutoEventWireup="true" CodeFile="fullPrice_OverSales.aspx.cs" Inherits="myPrice_fullPrice_OverSales" %>
    ...
    <script>
        $(function () {
           ...
           */
            $('#listTable').DataTable({
                "processing": true,
                "ajax": "../Ajax_Data/GetFullPriceData_OverSales.ashx?DataID=<%=Req_DataID%>",
                "searching": true,  //搜尋
                "ordering": true,   //排序
                "paging": true,     //分頁
                "info": false,      //筆數資訊
                ...
                "columns": [
                    ...
                    { "data": "BarCode" },
                    { "data": "Packing_en_US", "orderable": false },
                    { "data": "Ship_From" },
                ...
                {
                    "targets": 5,   //第 5 欄, 價格四捨五入取到小數第2位
                    "data": "myPrice",
                    "render": function (data, type, full, meta) {
                        var ShowPrice = full.ShowPrice;

                        return (ShowPrice == 'Y') ? Math.round(data * 100) / 100 : '-';
                    }
                }],
