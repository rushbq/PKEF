<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SupplierDelivery_sh.aspx.cs"
    Inherits="SupplierDelivery_sh" %>
...
<body class="MainArea">
    ...
    <div class="Navi">
        <a><%=Application["WebName"]%></a>&gt;<a>生產採購</a>&gt;<span>供應商交期(上海)</span>
    </div>
    <div class="h2Head">
        <h2>
            供應商交期(上海)</h2>
