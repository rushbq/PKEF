...
public partial class SupplierDelivery_tw : SecurityIn
{
    ...
    private void LookupDataList(int page)
    {
        ...
        {
            //[參數宣告] - 設定本頁Url
            this.ViewState["Page_LinkStr"] = Application["WebUrl"] + "Purchasing/SupplierDelivery_tw.aspx?func=sd";
            ...
            SBSql.AppendLine("    FROM [prokit2].dbo.PURMA ");
            SBSql.AppendLine("      LEFT JOIN [prokit2].dbo.SupplierA Sup ON PURMA.MA001 = Sup.SupCode ");
            SBSql.AppendLine("      LEFT JOIN [prokit2].dbo.CMSMV ON PURMA.MA047 = CMSMV.MV001 ");
    ...
    private void Get_Employee()
    {
        try
        {
            ...
            using (SqlCommand cmd = new SqlCommand())
            {
                ...
                SBSql.AppendLine(" FROM [DSCSYS].[dbo].DSCMA INNER JOIN [prokit2].dbo.CMSMV AS Acc ");
    ...
    protected void btn_Search_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            SBUrl.Append("SupplierDelivery_tw.aspx?func=sd");
    ...
    protected void lbtn_Export_Click(object sender, EventArgs e)
    {
        ...
        {
            StringBuilder SBUrl = new StringBuilder();
            SBUrl.Append("SupplierDelivery_tw_Excel.aspx?func=sd");
