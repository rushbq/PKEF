<%@ Page Title="電商庫存 | 匯入Excel" Language="C#" MasterPageFile="~/SiteMaster.master" AutoEventWireup="true" CodeFile="StockImportStep3.aspx.cs" Inherits="mySZBBC_Toy_StockImportStep3" %>
...
<asp:Content ID="myBottom" ContentPlaceHolderID="BottomContent" runat="Server">
    <asp:PlaceHolder ID="ph_Buttons" runat="server">
        <div class="container">
            <div class="section row">
                <div class="col s6">
                    <a class="btn-large waves-effect waves-light grey" href="<%=fn_Params.WebUrl %>mySZBBC_Toy/StockImportStep2.aspx?dataID=<%=Req_DataID %>">上一步，選擇工作表<i class="material-icons left">arrow_back</i></a>
                </div>
                <div class="col s6 right-align">
                    <a href="<%=fn_Params.WebUrl %>mySZBBC_Toy/StockDataList.aspx" class="btn-large waves-effect waves-light blue">離開此頁，前往列表</a>
                </div>
            </div>
        </div>
    </asp:PlaceHolder>
