...
public partial class mySZBBC_ShipmentHistory : SecurityIn
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                //[權限判斷]
                if (fn_CheckAuth.CheckAuth_User("921", out ErrMsg) == false)
                {
    ...
    {
        return "{0}mySZBBC_Toy/ShipmentHistory.aspx".FormatThis(
            fn_Params.WebUrl);
    }
    ...
    public string Page_SearchUrl
    {
        get
        {
            ...
            return string.IsNullOrWhiteSpace(tempUrl) ? "{0}mySZBBC_Toy/ShipmentList.aspx".FormatThis(fn_Params.WebUrl) : Server.UrlDecode(tempUrl);
        }
        set
        {
