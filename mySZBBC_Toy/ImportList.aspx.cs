...
public partial class mySZBBC_ImportList : SecurityIn
{
    ...
    public string keepGoUrl(int status, string dataID)
    {
        ...
        {
            case 12:
                return "{0}mySZBBC_Toy/ImportStep4.aspx?dataID={1}".FormatThis(fn_Params.WebUrl, dataID);

            default:
                return "{0}mySZBBC_Toy/ImportStep2.aspx?dataID={1}".FormatThis(fn_Params.WebUrl, dataID);
        }
    }
    #endregion
    ...
    {
        return "{0}mySZBBC_Toy/ImportList.aspx".FormatThis(
            fn_Params.WebUrl);
    }
