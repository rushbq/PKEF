<%@ Page Title="玩具BBC | 匯入記錄" Language="C#" MasterPageFile="~/Site_S_UI.master" AutoEventWireup="true" CodeFile="ImportList.aspx.cs" Inherits="mySZBBC_ImportList" %>
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td class="left aligned collapsing">
                            ...
                            <a class="ui small grey basic icon button" href="<%#fn_Params.WebUrl %>mySZBBC_Toy/ImportLog.aspx?dataID=<%#Eval("Data_ID") %>" title="查看記錄">
