<%@ Page Title="玩具BBC | 匯入Excel" Language="C#" MasterPageFile="~/Site_S_UI.master" AutoEventWireup="true" CodeFile="ImportStep2-1.aspx.cs" Inherits="mySZBBC_ImportStep2_1" %>
                                                    ...
                                                    <div class="five wide field">
                                                        ...
                                                        <div>
                                                            <textarea id="invData-<%#Eval("OrderID") %>" class="showTip" data-id="<%#Eval("OrderID") %>"><%#string.IsNullOrEmpty(Eval("InvRemark").ToString())
                                                                ? defRemarkValue(Eval("ShipWho").ToString(),Eval("ShipmentNo").ToString(),Eval("ShipAddr").ToString(),Eval("ShipTel").ToString())
    ...
    <div id="tipPage" class="ui modal">
        <div class="content">
            ...
            <ul class="ui list">
                ...
                <li>若下拉選單查無資料，請至<a href="<%=fn_Params.WebUrl%>mySZBBC_Toy/RefCopmg.aspx?Mall=<%=hf_MallID.Value %>" target="_blank">商品對應</a>設定.</li>
        ...
        $(function () {
            ...
            */
            ...
            $(".doCreate").click(function () {
                ...
                var request = $.ajax({
                    url: '<%=fn_Params.WebUrl%>' + "mySZBBC_Toy/Ashx_BBCTempNewItem.ashx",
                    method: "POST",
            ...
            $(".doSave").click(function () {
                ...
                var request = $.ajax({
                    url: '<%=fn_Params.WebUrl%>' + "mySZBBC_Toy/Ashx_BBCTempData.ashx",
                    method: "POST",
                    contentType: 'application/json',    //傳送格式
                    dataType: "html",   //遠端回傳格式
