...
//平台對應
public partial class mySZBBC_Toy_ErpDataList : SecurityIn
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                //[權限判斷]
                if (fn_CheckAuth.CheckAuth_User("923", out ErrMsg) == false)
                {
    ...
    {
        return "{0}mySZBBC_Toy/ErpDataList.aspx".FormatThis(
            fn_Params.WebUrl);
    }
