...
public partial class mySZBBC_Toy_Import_VC : SecurityIn
{
    ...
    public string Page_SearchUrl
    {
        get
        {
            string tempUrl = "{0}mySZBBC_Toy/ImportList.aspx?Mall=3".FormatThis(fn_Params.WebUrl);
    ...
    {
        return "{0}SZBBC_Toy/VCGroup/".FormatThis(System.Web.Configuration.WebConfigurationManager.AppSettings["File_Folder"]);
    }
