<%@ Page Title="台灣BBC | 查看記錄" Language="C#" MasterPageFile="~/Site_S_UI.master" AutoEventWireup="true" CodeFile="View.aspx.cs" Inherits="myTWBBC_View" %>
                ...
                <div id="myStickyBody" class="thirteen wide column">
                    <div class="ui attached segment grey-bg lighten-5">
                                                ...
                                                <table class="ui celled compact small table" style="width: 100%">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th class="grey-bg lighten-3 center aligned collapsing">修改數量</th>
                        ...
                        <div class="ui segments">
                            ...
                            <div class="ui segment">
                                <div class="ui top attached tabular menu">
                                    <a class="item active" data-tab="tw1">台灣
                                        <div class="ui label">
                                            <asp:Literal ID="lt_CntTW_1" runat="server">0</asp:Literal>
                                        </div>
                                    </a>
                                    <a class="item" data-tab="sh1">上海
                                        <div class="ui label">
                                            <asp:Literal ID="lt_CntSH_1" runat="server">0</asp:Literal>
                                        </div>
                                    </a>
                                </div>
                                <div class="ui bottom attached tab segment active" data-tab="tw1">
                                ...
                                <div class="ui bottom attached tab segment" data-tab="sh1">
                                    <asp:ListView ID="lv_OrderList_sh1" runat="server" ItemPlaceholderID="ph_Items">
                                        <LayoutTemplate>
                                            <table class="ui celled small table">
                                                <thead>
                                                    <tr>
                        ...
                        <div class="ui segments">
                            ...
                            <div class="ui segment">
                                <div class="ui top attached tabular menu">
                                    <a class="item active" data-tab="tw2">台灣
                                        <div class="ui label">
                                            <asp:Literal ID="lt_CntTW_2" runat="server">0</asp:Literal>
                                        </div>
                                    </a>
                                    <a class="item" data-tab="sh2">上海
                                        <div class="ui label">
                                            <asp:Literal ID="lt_CntSH_2" runat="server">0</asp:Literal>
                                        </div>
                                    </a>
                                </div>
                                <div class="ui bottom attached tab segment active" data-tab="tw2">
                                ...
                                <div class="ui bottom attached tab segment" data-tab="sh2">
                                    <asp:ListView ID="lv_SalesOrderList_sh2" runat="server" ItemPlaceholderID="ph_Items">
                                        <LayoutTemplate>
                                            <table class="ui celled small table">
                                                <thead>
                                                    <tr>
