<%@ Page Title="台灣BBC | 匯入記錄" Language="C#" MasterPageFile="~/Site_S_UI.master" AutoEventWireup="true" CodeFile="ImportList.aspx.cs" Inherits="myTWBBC_ImportList" %>
    ...
    <div class="myContentHeader">
        <div class="ui small menu toolbar">
            ...
            <div class="right menu">
                <a href="ImportStep1.aspx" class="item"><i class="plus icon"></i><span class="mobile hidden">新增匯入</span></a>
            </div>
        </div>
    </div>
    <!-- 工具列 End -->
            ...
            <div class="ui small form">
                <div class="fields">
                    ...
                    <div class="four wide field">
                        <label>狀態</label>
                        <asp:DropDownList ID="filter_Status" runat="server" CssClass="fluid"></asp:DropDownList>
                    </div>
                    <div class="six wide field">
                        <label>關鍵字查詢</label>
                    ...
                    <tr>
                        ...
                        <td class="left aligned collapsing">
                            <asp:PlaceHolder ID="ph_KeepGo" runat="server">
                                <a class="ui small teal basic icon button" href="<%#keepGoingUrl(Convert.ToInt16( Eval("Status")), Eval("Data_ID").ToString()) %>" title="繼續匯入">
                                    <i class="pencil icon"></i>
                                </a>
                            </asp:PlaceHolder>
                            <a class="ui small grey basic icon button" href="<%#fn_Params.WebUrl %>myTWBBC/View.aspx?id=<%#Eval("Data_ID") %>" title="查看記錄">
