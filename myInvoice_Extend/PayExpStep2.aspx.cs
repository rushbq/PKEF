...
public partial class myInvoice_Extend_PayExpStep2 : SecurityIn
{
    ...
    private void LookupData_Detail()
    {
        ...
        {
            //----- 原始資料:取得所有資料 -----
            var query = _data.Get_PaymentData_DT(Req_DataID, out ErrMsg);
    ...
    protected void btn_Back_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            if (!_data.Delete_PaymentData(Req_DataID))
            {
    ...
    public string thisPage
    {
        get
        {
            return "{0}/PayExpStep2.aspx?id={1}".FormatThis(FuncPath(), Req_DataID);
        }
        set
        {
