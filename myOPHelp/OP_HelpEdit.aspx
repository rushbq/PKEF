<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OP_HelpEdit.aspx.cs" Inherits="OP_HelpEdit" %>
...
<body class="MainArea">
    <form id="form1" runat="server">
        <div class="Navi">
            <a><%=Application["WebName"]%></a>&gt;<a>需求記錄表</a>&gt;<span>品號修改需求登記</span>
        </div>
        <div class="h2Head">
        ...
        <div class="SysTab">
            <ul>
                <li class="TabAc"><a href="<%=PageUrl %>">資料填寫</a></li>
        ...
        <table class="TableModify">
            <!-- 基本資料 Start -->
            <tr class="ModifyHead">
                <td colspan="4">品號修改資料<em class="TableModifyTitleIcon"></em>
                </td>
            </tr>
            <tbody>
                <tr>
                ...
                <tr class="Must">
                    ...
                    <td class="TableModifyTd">
                        <asp:TextBox ID="tb_Help_Subject" runat="server" MaxLength="40" Width="400px" placeholder="品號修改主旨"></asp:TextBox>
                            ...
                            <asp:ListView ID="lvDataList" runat="server" GroupPlaceholderID="ph_Group" ItemPlaceholderID="ph_Items"
                                ...
                                <ItemTemplate>
                                    <td align="center" valign="top" width="25%">
                                        ...
                                        <div>
                                            <%#PicUrl(Eval("AttachFile").ToString(), true)%>
                                        </div>
                                    </td>
                                </ItemTemplate>
                                <EmptyItemTemplate>
                ...
                <tr class="Must">
                    ...
                    <td class="TableModifyTd">
                        <asp:TextBox ID="tb_Help_Content" runat="server" Width="90%" Rows="10" TextMode="MultiLine"
                            MaxLength="500" placeholder="請填寫「品號修改詳細說明」，愈詳細愈好！"></asp:TextBox>
                        <br />
                        ...
                        &nbsp;<asp:RequiredFieldValidator ID="rfv_tb_Help_Content" runat="server" ControlToValidate="tb_Help_Content"
                            Display="Dynamic" ErrorMessage="-&gt; 請填寫「品號修改詳細說明」，愈詳細愈好！" ForeColor="Red" ValidationGroup="Add"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    ...
                    <tr>
                        ...
                        <td class="TableModifyTd">
                            <asp:TextBox ID="tb_Reply_Hours"
                                runat="server" Width="60px" MaxLength="4" Style="text-align: center;"></asp:TextBox>
                            hr(s)
