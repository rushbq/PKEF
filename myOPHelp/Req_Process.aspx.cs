...
public partial class Recording_Req_Process : SecurityIn
{
    ...
    private void LookupData()
    {
        ...
        using (SqlCommand cmd = new SqlCommand())
        {
            ...
            SBSql.AppendLine(" FROM OP_Help Base");
    ...
    protected void lbtn_No_Click(object sender, EventArgs e)
    {
        using (SqlCommand cmd = new SqlCommand())
        {
            ...
            SBSql.AppendLine(" UPDATE OP_Help SET IsAgree = 'N', Agree_Who = @Agree_Who, Agree_Time = GETDATE()");
    ...
    protected void lbtn_Yes_Click(object sender, EventArgs e)
    {
        using (SqlCommand cmd = new SqlCommand())
        {
            ...
            SBSql.AppendLine(" UPDATE OP_Help SET IsAgree = 'Y', Agree_Who = @Agree_Who, Agree_Time = GETDATE()");
            SBSql.AppendLine(" WHERE (TraceID = @TraceID)");
