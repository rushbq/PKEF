...
public partial class Google_OPGetData : System.Web.UI.Page
{
    /// <summary>
    /// 案件數(類別)
    /// </summary>
    ...
    public static List<Data> GetHourByClass(string StartDate, string EndDate)
    {
        ...
        using (SqlCommand cmd = new SqlCommand())
        {
            ...
            sbSQL.Append(" FROM OP_Help Base ");
            sbSQL.Append("  INNER JOIN OP_ParamClass ReqClass ON Base.Req_Class = ReqClass.Class_ID ");
