<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OP_HelpView.aspx.cs" Inherits="OP_HelpView" %>
                            ...
                            <asp:ListView ID="lvDataList" runat="server" GroupPlaceholderID="ph_Group" ItemPlaceholderID="ph_Items"
                                ...
                                <ItemTemplate>
                                    <td align="center" valign="top" width="25%">
                                        <div>
                                            <%#PicUrl(Eval("AttachFile").ToString())%>
                                        </div>
                                    </td>
                                </ItemTemplate>
                                <EmptyItemTemplate>
                ...
                <tr class="ModifyHead">
                    <td colspan="4">回覆資料<em class="TableModifyTitleIcon"></em>&nbsp;
                        <asp:PlaceHolder ID="ph_Reply" runat="server" Visible="false">
                            <a class="btnBlock colorRed" href="OP_HelpEdit.aspx?TraceID=<%= Server.UrlEncode(Cryptograph.MD5Encrypt(Param_thisID, DesKey))%>">我要回覆
                            </a>
                        </asp:PlaceHolder>
                    </td>
                </tr>
