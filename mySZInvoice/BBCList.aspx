<%@ Page Title="深圳-開票平台" Language="C#" MasterPageFile="~/SiteMaster.master" AutoEventWireup="true" CodeFile="BBCList.aspx.cs" Inherits="mySZInvoice_BBCList" %>
                    ...
                    <div class="card-content">
                        <div class="row">
                            ...
                            <div class="input-field col s4 right-align">
                                ...
                                <a href="<%=Application["WebUrl"] %>mySZInvoice/BBCStep1.aspx" class="btn waves-effect waves-light purple" title="多筆新增"><i class="material-icons">playlist_add</i></a>
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td class="grey-text text-darken-3">
                                    <a href="<%=Application["WebUrl"] %>mySZInvoice/View.aspx?dataID=<%#Eval("Data_ID") %>&type=2" class="green-text text-darken-2" title="詳細"><%#Eval("Inv_Subject") %></a>
                                </td>
                                <td>
                                    <%#Eval("Inv_NO") %>
                                </td>
            ...
            $(".doUpdate").on("click", function () {
                ...
                var request = $.ajax({
                    ...
                    data: {
                        ...
                        type: 'U',
                        invtype: '2' //1:一般紙本發票(SZ) 2:電商紙本發票(SH) ***注意,不可寫錯***
                    },
                    dataType: "html"
                });
