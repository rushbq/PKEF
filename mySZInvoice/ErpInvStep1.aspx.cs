...
public partial class mySZInvoice_ErpInvStep1 : SecurityIn
{
    ...
    protected void btn_Next_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            //Next Step
            Response.Redirect("{0}mySZInvoice/ErpInvStep2.aspx?cust={1}&sd={2}&ed={3}".FormatThis(
                   Application["WebUrl"]
    ...
    public string PageUrl
    {
        get
        {
            return "{0}mySZInvoice/ErpInvStep1.aspx".FormatThis(Application["WebUrl"]);
        }
        set
        {
            this._PageUrl = value;
