<%@ Page Title="深圳-開票平台" Language="C#" MasterPageFile="~/SiteMaster.master" AutoEventWireup="true" CodeFile="BBCStep1.aspx.cs" Inherits="mySZInvoice_BBCStep1" %>
        ...
        <div class="container">
            <div class="row">
                <div class="col s12 m12 l12">
                    ...
                    <ol class="breadcrumb">
                        <li><a>深圳-開票平台</a></li>
                        <li><a href="<%=Application["WebUrl"] %>mySZInvoice/BBCList.aspx">電商紙本發票</a></li>
...
<asp:Content ID="myBottom" ContentPlaceHolderID="BottomContent" runat="Server">
    <asp:PlaceHolder ID="ph_Buttons" runat="server">
        <div class="container">
            <div class="section row">
                <div class="col s6">
                    <a href="<%=Application["WebUrl"] %>mySZInvoice/BBCList.aspx" class="btn-large waves-effect waves-light grey">取消，返回列表<i class="material-icons left">arrow_back</i></a>
                </div>
