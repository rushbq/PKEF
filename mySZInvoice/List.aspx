<%@ Page Title="深圳-開票平台" Language="C#" MasterPageFile="~/SiteMaster.master" AutoEventWireup="true" CodeFile="List.aspx.cs" Inherits="mySZInvoice_List" %>
                    ...
                    <div class="card-content">
                        <div class="row">
                            ...
                            <div class="input-field col s4 right-align">
                                ...
                                <a href="<%=Application["WebUrl"] %>mySZInvoice/Step1.aspx" class="btn waves-effect waves-light red" title="單筆新增"><i class="material-icons">add</i></a>
                                <a href="<%=Application["WebUrl"] %>mySZInvoice/BatchStep1.aspx" class="btn waves-effect waves-light purple" title="多筆新增"><i class="material-icons">playlist_add</i></a>
                                <a href="<%=Application["WebUrl"] %>mySZInvoice/ErpInvStep1.aspx" class="btn waves-effect waves-light teal" title="手動填寫發票號"><i class="material-icons">update</i></a>
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td class="grey-text text-darken-3">
                                    <a href="<%=Application["WebUrl"] %>mySZInvoice/View.aspx?dataID=<%#Eval("Data_ID") %>&type=1" class="green-text text-darken-2" title="詳細"><%#Eval("Inv_Subject") %></a>
                                </td>
                                <td>
                                    <%#Eval("Inv_NO") %>
                                </td>
                                ...
                                <td class="center-align">
                                    <div class="procBtns">
                                        <asp:PlaceHolder ID="ph_Edit" runat="server">
                                            <a href="<%=Application["WebUrl"] %>mySZInvoice/Step2.aspx?dataID=<%#Eval("Data_ID") %>" class="btn waves-effect waves-light green doProcess" title="繼續轉入,進入預覽頁"><i class="material-icons">edit</i></a>
    ...
    <script>
        $(function () {
            ...
            $(".doUpdate").on("click", function () {
                ...
                var request = $.ajax({
                    url: '<%=Application["WebUrl"]%>' + "mySZInvoice/Ashx_UpdateData.ashx",
                    method: "POST",
                    data: {
                        DataID: _dataID,
                        Who: '<%=fn_Params.UserGuid%>',
                        type: 'U',
                        invtype: '1' //1:一般紙本發票(SZ) 2:電商紙本發票(SH) ***注意,不可寫錯***
                    },
                    dataType: "html"
                });
