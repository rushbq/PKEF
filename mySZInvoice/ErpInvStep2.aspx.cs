...
public partial class mySZInvoice_ErpInvStep2 : SecurityIn
{
    ...
    private void LookupData()
    {
        ...
        if (_datalist == null || _datalist.Count() == 0)
        {
            this.ph_Content.Visible = false;
            this.ph_Buttons.Visible = false;
            CustomExtension.AlertMsg("查無資料,請重選條件!", "{0}mySZInvoice/ErpInvStep1.aspx".FormatThis(Application["WebUrl"]));
            return;
        }
