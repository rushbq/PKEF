<%@ Page Title="上海BBC | 匯入Excel" Language="C#" MasterPageFile="~/SiteMaster.master" AutoEventWireup="true" CodeFile="ImportStep5.aspx.cs" Inherits="mySHBBC_ImportStep5" %>
            ...
            <div class="card-panel">
                ...
                <div class="section row">
                    <div class="col s12 right-align">
                        <a class="btn-large waves-effect waves-light green" href="<%=fn_Params.WebUrl %>mySHBBC/ImportIndex.aspx">開始新的匯入<i class="material-icons left">autorenew</i></a>
                        <a class="btn-large waves-effect waves-light blue" href="<%=fn_Params.WebUrl %>mySHBBC/ImportLog.aspx?dataID=<%=Req_DataID %>">查看此次記錄<i class="material-icons left">history</i></a>
                    </div>
                </div>
            </div>
        </asp:PlaceHolder>
