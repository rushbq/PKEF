<%@ Page Title="上海BBC | 匯入Excel" Language="C#" MasterPageFile="~/SiteMaster.master" AutoEventWireup="true" CodeFile="ImportStep2.aspx.cs" Inherits="mySHBBC_ImportStep2" %>
                    ...
                    <div class="col s12">
                        ...
                        <div>
                            <ul class="collection">
                                ...
                                <li class="collection-item"><i class="material-icons left">info</i>京東POP、天貓商品對應為一對多,請<a href="<%=fn_Params.WebUrl %>mySHBBC/RefCopmg.aspx?Mall=2">前往此頁設定</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
