<%@ Page Title="上海BBC | 京東VC批量退貨" Language="C#" MasterPageFile="~/SiteMaster.master" AutoEventWireup="true" CodeFile="RebImport_VC.aspx.cs" Inherits="mySHBBC_Import_VC" %>
        ...
        <div class="container">
            <div class="row">
                <div class="col s12 m12 l12">
                    <h5 class="breadcrumbs-title">京東VC批量退貨</h5>
                    <ol class="breadcrumb">
                        <li><a>上海BBC</a></li>
                        <li class="active"><a>京東VC批量退貨</a></li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="col s12">
                        ...
                        <div>
                            <ul class="collection">
                                ...
                                <li class="collection-item"><i class="material-icons left">info</i>上傳後,系統會自動將所有客戶(機構)拆成單一客戶</li>
                                <li class="collection-item blue-text"><i class="material-icons left">info</i>上傳成功,「BT」開頭的追蹤編號為批量匯入的檔案</li>
