<%@ Page Title="電商庫存 | 匯入Excel" Language="C#" MasterPageFile="~/SiteMaster.master" AutoEventWireup="true" CodeFile="StockImportStep1.aspx.cs" Inherits="mySHBBC_StockImportStep1" %>
...
<asp:Content ID="myBottom" ContentPlaceHolderID="BottomContent" runat="Server">
    <asp:PlaceHolder ID="ph_Buttons" runat="server">
        <div class="container">
            <div class="section row">
                <div class="col s6">
                    <a class="btn-large waves-effect waves-light grey" href="<%=fn_Params.WebUrl %>/mySHBBC/StockDataList.aspx">返回列表<i class="material-icons left">arrow_back</i></a>
                </div>
