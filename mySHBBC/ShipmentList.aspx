<%@ Page Title="出貨明細表" Language="C#" MasterPageFile="~/Site_S_UI.master" AutoEventWireup="true" CodeFile="ShipmentList.aspx.cs" Inherits="mySHBBC_ShipmentList" %>
    ...
    <div class="myContentHeader">
        <div class="ui small menu toolbar">
            ...
            <div class="right menu">
                <a href="<%=fn_Params.WebUrl %>mySHBBC/ShipmentHistory.aspx" class="item"><i class="history icon"></i><span class="mobile hidden">匯出記錄</span></a>
