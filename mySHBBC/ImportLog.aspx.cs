...
public partial class mySHBBC_ImportLog : SecurityIn
{
    ...
    public string Page_SearchUrl
    {
        get
        {
            ...
            return string.IsNullOrWhiteSpace(tempUrl) ? "{0}mySHBBC/ImportList.aspx".FormatThis(fn_Params.WebUrl) : Server.UrlDecode(tempUrl);
        }
        set
        {
    ...
    public string UploadFolder
    {
        get
        {
            return "{0}SHBBC/".FormatThis(System.Web.Configuration.WebConfigurationManager.AppSettings["Ftp_RefUrl"] + System.Web.Configuration.WebConfigurationManager.AppSettings["File_Folder"]);
        }
        set
        {
