<%@ Page Title="上海BBC | 匯入Excel" Language="C#" MasterPageFile="~/SiteMaster.master" AutoEventWireup="true" CodeFile="ImportStep1.aspx.cs" Inherits="mySHBBC_ImportStep1" %>
    ...
    <div class="container">
        <asp:PlaceHolder ID="ph_Message" runat="server">
            <div class="card-panel red darken-1 white-text">
                ...
                <p><a class="btn waves-effect waves-light grey darken-1" href="<%=fn_Params.WebUrl %>mySHBBC/ImportIndex.aspx">請點此返回, 再重新操作一次.</a></p>
            </div>
        </asp:PlaceHolder>
...
<asp:Content ID="myBottom" ContentPlaceHolderID="BottomContent" runat="Server">
    <asp:PlaceHolder ID="ph_Buttons" runat="server">
        <div class="container">
            <div class="section row">
                <div class="col s6">
                    <a class="btn-large waves-effect waves-light grey" href="<%=fn_Params.WebUrl %>/mySHBBC/ImportIndex.aspx">上一步，選擇模式<i class="material-icons left">arrow_back</i></a>
                </div>
...
<asp:Content ID="myScript" ContentPlaceHolderID="ScriptContent" runat="Server">
    ...
    <link href="<%=fn_Params.CDNUrl %>plugin/jqueryUI/catcomplete/catcomplete.css" rel="stylesheet" />
    <script src="<%=fn_Params.CDNUrl %>plugin/jqueryUI/jquery-ui.min.js"></script>
    <script src="<%=fn_Params.CDNUrl %>plugin/jqueryUI/catcomplete/catcomplete.js"></script>
    <%-- Catcomplete Start --%>
    <script>
        /* Autocomplete 客戶 */
        $(".AC-Customer").autocomplete({
            ...
            source: function (request, response) {
                $.ajax({
                    url: "<%=fn_Params.WebUrl%>Ajax_Data/GetData_Customer.ashx?corp=3",
                    data: {
