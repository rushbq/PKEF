<%@ Page Title="電商庫存表" Language="C#" MasterPageFile="~/Site_S_UI.master" AutoEventWireup="true" CodeFile="StockDataList.aspx.cs" Inherits="mySHBBC_StockDataList" %>
    ...
    <div class="myContentHeader">
        <div class="ui small menu toolbar">
            ...
            <div class="right menu">
                ...
                <a class="item" href="<%=fn_Params.WebUrl %>mySHBBC/StockImportStep1.aspx">
                    <i class="plus icon"></i>
