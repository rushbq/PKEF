...
<body class="MainArea">
    ...
    <div class="Sift">
        <ul>
            ...
            <li>客戶關鍵字：
                <asp:TextBox ID="tb_Keyword" runat="server" MaxLength="50" Width="180px" ToolTip="客戶代號/簡稱/全稱"></asp:TextBox>
            </li>
            <li>
                ...
                <asp:PlaceHolder ID="ph_Edit" runat="server">|
                    <input type="button" value="新增資料" onclick="location.href='Cust_Edit.aspx';" class="btnBlock colorBlue" />
                </asp:PlaceHolder>
            </li>
        </ul>
    </div>
    <asp:ListView ID="lvDataList" runat="server" ItemPlaceholderID="ph_Items" OnItemCommand="lvDataList_ItemCommand">
        ...
        <ItemTemplate>
            <tr id="trItem" runat="server" align="center">
                ...
                <td align="center">
                    <asp:PlaceHolder ID="ph_Edit" runat="server"><a class="Edit" href="Cust_Edit.aspx?ShipFrom=<%# Server.UrlEncode(Eval("ShipFrom").ToString())%>&CustID=<%# Server.UrlEncode(Eval("CustID").ToString())%>&SetYear=<%# Server.UrlEncode(Eval("SetYear").ToString())%>&ShowDT=Y">
                        設定</a><br />
