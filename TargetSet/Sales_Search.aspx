        ...
        <ul>
            ...
            <li>
                ...
                <asp:PlaceHolder ID="ph_Edit" runat="server">|
                    <input type="button" value="新增資料" onclick="location.href='Sales_Edit.aspx';" class="btnBlock colorBlue" />
                </asp:PlaceHolder>
            </li>
        </ul>
    </div>
    <asp:ListView ID="lvDataList" runat="server" ItemPlaceholderID="ph_Items" OnItemCommand="lvDataList_ItemCommand">
        ...
        <ItemTemplate>
            <tr id="trItem" runat="server" align="center">
                ...
                <td>
                    <asp:PlaceHolder ID="ph_Edit" runat="server"><a class="Edit" href="Sales_Edit.aspx?ShipFrom=<%# Server.UrlEncode(Eval("ShipFrom").ToString())%>&DeptID=<%# Server.UrlEncode(Eval("DeptID").ToString())%>&SetYear=<%# Server.UrlEncode(Eval("SetYear").ToString())%>&StaffID=<%# Server.UrlEncode(Eval("StaffID").ToString())%>&ShowDT=Y">
                        設定</a><br />
