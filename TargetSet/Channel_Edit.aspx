...
<body class="MainArea">
    <form id="form1" runat="server">
        ...
        <div class="h2Head">
            <h2>通路目標設定 - <strong class="styleRed"><%=fn_Desc.TargetTypeDesc(Param_Type) %></strong></h2>
        </div>
        ...
        <table class="TableModify">
            <tr class="ModifyHead">
                <td colspan="4">通路目標<em class="TableModifyTitleIcon"></em>
                </td>
            </tr>
            <!-- 資料設定 Start -->
            <tbody>
                    ...
                    <asp:ListView ID="lvDataList" runat="server" ItemPlaceholderID="ph_Items" OnItemCommand="lvDataList_ItemCommand">
                        <LayoutTemplate>
                            <table class="List1" width="100%">
                                <tr class="tdHead">
                                    ...
                                    <td colspan="3">銷售</td>
                                    <td colspan="3">接單</td>
                                    <td width="80px" rowspan="2">功能選項</td>
                                </tr>
                                <tr class="tdHead">
                                    <td>USD</td>
                                    <td>NTD</td>
                        ...
                        <ItemTemplate>
                            <tr id="trItem" runat="server" align="center">
                                ...
                                <td align="center">
                                    <a class="Edit" href="Channel_Edit.aspx?t=<%=Param_Type %>&EditID=<%# Server.UrlEncode(Cryptograph.Encrypt(Eval("UID").ToString()))%>">修改</a><br />
