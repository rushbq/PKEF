    ...
    <form id="form1" runat="server">
        ...
        <div class="Sift">
            <ul>
                ...
                <li>通路別：
                    <asp:DropDownList ID="ddl_Channel" runat="server" CssClass="styleBlack">
                    </asp:DropDownList>
                </li>
                <li>
                    ...
                    <input type="button" value="新增資料" onclick="location.href = 'Channel_Edit.aspx?t=<%=Param_Type%>'" class="btnBlock colorBlue" />
                    </asp:PlaceHolder>
                </li>
            </ul>
        </div>
        <div class="table-responsive">
            <div class="SysTab3">
                <%=fn_CustomUI.GetTabHtml(Param_Type,"Channel_Search.aspx") %>
            </div>
            <asp:ListView ID="lvDataList" runat="server" ItemPlaceholderID="ph_Items" OnItemCommand="lvDataList_ItemCommand">
                <LayoutTemplate>
                    <table class="List1" width="100%">
                        <tr class="tdHead">
                            <td width="150px" rowspan="3">通路</td>
                ...
                <ItemTemplate>
                    <tr id="trItem" runat="server" align="center">
                        ...
                        <td align="center">
                            <asp:PlaceHolder ID="ph_Edit" runat="server">
                                <p>
                                    <a class="btn btn-primary btn-sm" href="Channel_Edit.aspx?t=<%=Param_Type %>&ShipFrom=<%# Server.UrlEncode(Eval("ShipFrom").ToString())%>&CID=<%# Server.UrlEncode(Eval("CID").ToString())%>&SetYear=<%# Server.UrlEncode(Eval("SetYear").ToString())%>&ShowDT=Y">
