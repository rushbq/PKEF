...
public partial class Cust_ViewAll : SecurityIn
{
    //總計
    ...
    private void View_DataList()
    {
        try
        {
            ...
            using (SqlCommand cmd = new SqlCommand())
            {
                ...
                SBSql.AppendLine(" SELECT UID, ShipFrom, CustID, SetYear, SetMonth");
                ...
                cmd.Parameters.AddWithValue("CustID", Param_CustID);
    ...
    /// 客戶
    /// </summary>
    private string _Param_CustID;
    public string Param_CustID
    {
        get
        {
            return string.IsNullOrEmpty(Request.QueryString["CustID"]) ? "" : Request.QueryString["CustID"].ToString();
        }
        set
        {
            this._Param_CustID = value;
        }
    }
