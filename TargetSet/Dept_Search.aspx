...
<body class="MainArea">
    ...
    <div class="Sift">
        <ul>
            ...
            <li>區域：<asp:DropDownList ID="ddl_ShipFrom" runat="server">
            </asp:DropDownList>
            </li>
            <li>部門：
            ...
            <li>
                ...
                <asp:PlaceHolder ID="ph_Edit" runat="server">|
                    <input type="button" value="新增資料" onclick="location.href='Dept_Edit.aspx';" class="btnBlock colorBlue" />
                </asp:PlaceHolder>
            </li>
        </ul>
    </div>
            ...
            <tr id="trItem" runat="server">
                ...
                <td align="center" class="JQ-ui-state-default">
                    <a href="<%# myUrl_ViewItem(new string[]{
                                    ...
                                    ,"Amount_USD", "銷售金額(USD)"
                                    , Eval("DeptName").ToString()})%>" class="styleBlue infoBox" title="展開 - 銷售金額(USD)">
                ...
                <td align="center" class="JQ-ui-state-default">
                    <a href="<%# myUrl_ViewItem(new string[]{
                                    ...
                                    , Eval("SetYear").ToString()
                                    ,"Amount_NTD", "銷售金額(NTD)"
                                    , Eval("DeptName").ToString()})%>" class="styleBlue infoBox" title="展開 - 銷售金額(NTD)">
                ...
                <td align="center" class="JQ-ui-state-default">
                    <a href="<%# myUrl_ViewItem(new string[]{
                                    ...
                                    , Eval("SetYear").ToString()
                                    ,"Amount_RMB", "銷售金額(RMB)"
                                    , Eval("DeptName").ToString()})%>" class="styleBlue infoBox" title="展開 - 銷售金額(RMB)">
                ...
                <td align="center" class="JQ-ui-state-default">
                    <a href="<%# myUrl_ViewItem(new string[]{
                                    ...
                                    , Eval("DeptName").ToString()})%>" class="infoBox" title="展開 - 接單金額(USD)">
                ...
                <td align="center" class="JQ-ui-state-default">
                    <a href="<%# myUrl_ViewItem(new string[]{
                                    ...
                                    , Eval("DeptName").ToString()})%>" class="infoBox" title="展開 - 接單金額(NTD)">
                ...
                <td align="center" class="JQ-ui-state-default">
                    <a href="<%# myUrl_ViewItem(new string[]{
                                    ...
                                    , Eval("DeptName").ToString()})%>" class="infoBox" title="展開 - 接單金額(RMB)">
                ...
                <td align="center" class="JQ-ui-state-default">
                    <a href="<%# myUrl_ViewItem(new string[]{
                                    ...
                                    , Eval("DeptName").ToString()})%>" class="styleReddark infoBox" title="展開 - 挑戰金額(USD)">
                ...
                <td align="center" class="JQ-ui-state-default">
                    <a href="<%# myUrl_ViewItem(new string[]{
                                    ...
                                    , Eval("DeptName").ToString()})%>" class="styleReddark infoBox" title="展開 - 挑戰金額(NTD)">
                ...
                <td align="center" class="JQ-ui-state-default">
                    <a href="<%# myUrl_ViewItem(new string[]{
                                    ...
                                    , Eval("DeptName").ToString()})%>" class="styleReddark infoBox" title="展開 - 挑戰金額(RMB)">
                        <%#fn_stringFormat.C_format(Eval("ChAmount_RMB").ToString())%>
                        <span class="JQ-ui-icon ui-icon-newwin"></span></a>
                </td>
                <td align="center">
                    <asp:PlaceHolder ID="ph_Edit" runat="server"><a class="Edit" href="Dept_Edit.aspx?ShipFrom=<%# Server.UrlEncode(Eval("ShipFrom").ToString())%>&DeptID=<%# Server.UrlEncode(Eval("DeptID").ToString())%>&SetYear=<%# Server.UrlEncode(Eval("SetYear").ToString())%>">
                        設定</a><br />
