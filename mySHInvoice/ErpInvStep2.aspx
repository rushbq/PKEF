                            ...
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td class="input-field">
                                        ...
                                        <input id="InvDate_<%#Eval("SerialNo") %>" type="text" class="datepicker" maxlength="20" placeholder="填入發票日" value="<%#DateTime.Now.ToShortDateString() %>" />
                                    </td>
                                    <td>
                                    ...
                                    <td class="center-align">
                                        ...
                                        <button type="button" class="btn waves-effect waves-light green lighten-1 doUpdate" data-id="<%#Eval("Erp_AR_ID") %>" data-target="InvNo_<%#Eval("SerialNo") %>" data-dt="InvDate_<%#Eval("SerialNo") %>" title="更新ERP發票號碼"><i class="material-icons">save</i></button>
                                    </td>
                                </tr>
                            </ItemTemplate>
                        </asp:ListView>
...
<asp:Content ID="myBottom" ContentPlaceHolderID="BottomContent" runat="Server">
    <asp:PlaceHolder ID="ph_Buttons" runat="server">
        <div class="container">
            <div class="section row">
                <div class="col s6">
                    <a href="<%=Application["WebUrl"] %>mySHInvoice/ErpInvStep1.aspx" class="btn-large waves-effect waves-light grey">回上一步，重新選擇<i class="material-icons left">autorenew</i></a>
                </div>
    ...
    <script>
        $(function () {
            ...
            $(".doUpdate").on("click", function () {
                ...
                var _target = $(this).attr("data-target"); //發票號碼欄
                var _targetDate = $(this).attr("data-dt"); //發票日期欄
                var _dataVal = $("#" + _target).val();
                var _dataDTVal = $("#" + _targetDate).val();
                var _btn = $(this);
                ...
                var request = $.ajax({
                    url: '<%=Application["WebUrl"]%>' + "mySHInvoice/Ashx_UpdateErpInvoice.ashx",
                    method: "POST",
                    data: {
                        DataID: _dataID,
