<%@ Page Title="上海會計 | 百旺開票-電商發票" Language="C#" MasterPageFile="~/SiteMaster.master" AutoEventWireup="true" CodeFile="BBCList.aspx.cs" Inherits="mySHInvoice_BBCList" %>
                    ...
                    <div class="card-content">
                        <div class="row">
                            ...
                            <div class="input-field col s4 right-align">
                                ...
                                <a href="<%=fn_Params.WebUrl %>mySHInvoice/BBCStep1.aspx" class="btn waves-effect waves-light purple" title="多筆新增"><i class="material-icons">playlist_add</i></a>
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td class="grey-text text-darken-3">
                                    <a href="<%=fn_Params.WebUrl %>mySHInvoice/View.aspx?dataID=<%#Eval("Data_ID") %>&type=2" class="green-text text-darken-2" title="詳細"><%#Eval("Inv_Subject") %></a>
                                </td>
                                <td>
                                    <%#Eval("Inv_NO") %>
                                </td>
