...
public partial class mySHInvoice_Step1 : SecurityIn
{
    ...
    protected void btn_Next_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                //前往下一步
                Response.Redirect("{0}mySHInvoice/Step2.aspx?dataID={1}".FormatThis(
                    fn_Params.WebUrl
                    , getGuid));
            }
    ...
    public string PageUrl
    {
        get
        {
            return "{0}mySHInvoice/Step1.aspx".FormatThis(fn_Params.WebUrl);
        }
        set
        {
            this._PageUrl = value;
